package com.shvertex.simplibudgetrevamped.license
...
object SHVLicense {
    ...
    private const val BUNDLE_APP   = "simpli_budgetr"
    private const val ACT_PREFIX   = "SMPBUGR2026"
    private const val LICENSE_FILE = "shv_license_simpli_budgetr.json"
...

cwIDAQAB
-----END RSA PUBLIC KEY-----
    """.trimIndent()
