package com.example.interstellarcalc.license
...
object SHVLicense {
    ...
    private const val BUNDLE_APP   = "int_calc"
    private const val ACT_PREFIX   = "INTCALC2026"
    private const val LICENSE_FILE = "shv_license_int_calc.json"
...

tQIDAQAB
-----END RSA PUBLIC KEY-----
    """.trimIndent()
